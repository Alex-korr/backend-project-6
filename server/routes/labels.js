import {
  index, newLabel, create, edit, update, remove,
} from '../controllers/labels.js';
import ensureAuthenticated from '../middleware/ensureAuthenticated.js';

export default async (app) => {
  app.route({
    method: 'GET', url: '/labels', preHandler: [ensureAuthenticated], handler: index,
  });
  app.route({
    method: 'GET', url: '/labels/new', preHandler: [ensureAuthenticated], handler: newLabel,
  });
